...
@pytest.mark.parametrize(
    "nature, expected",
    [
        (Nature.ADAMANT, {"HP": 357, "ATTACK": 394, "DEFENCE": 226, "SP_ATTACK": 176, "SP_DEFENCE": 207, "SPEED": 303}),
        (Nature.JOLLY, {"HP": 357, "ATTACK": 359, "DEFENCE": 226, "SP_ATTACK": 176, "SP_DEFENCE": 207, "SPEED": 333}),
        (Nature.BASHFUL, {"HP": 357, "ATTACK": 359, "DEFENCE": 226, "SP_ATTACK": 196, "SP_DEFENCE": 207, "SPEED": 303}),
    ],
)
def test_garchomp_nature_effects(garchomp_setup: dict[str, Any], nature: Nature, expected: dict[str, int]):
    ...
    for stat, val in expected.items():
        assert asdict(totals)[stat] == val, f"{nature.name} {stat} mismatch"
